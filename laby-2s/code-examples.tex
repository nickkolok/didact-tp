...
\newpage
\codeexample{Цикл \textbf{for} и области видимости}{for-var-visibility}
\newpage
\codeexample{Инициализация генератора случайных чисел}{srand}
\newpage
\codeexample{Вычисление суммы ряда с заданной точностью}{for-while-epsilon}
\codeexample{Обращение к элементам статического массива с использованием указателей}{static-arrays-1d-2d-pointers}
\newpage
\codeexample{Обработка одномерного массива с использованием флага}{processing-array-with-flag}
\newpage
\codeexample{Удаление строк из двумерного массива}{removing-strings-from-2d-array}
\newpage
\codeexample{Отладочная фиксация: массив}{prehardcoded-input}
\newpage
\codeexample{Отладочная фиксация: три варианта массива}{prehardcoded-input-variants}
\newpage
\codeexample{Отладочная фиксация: массив, вводимый внутри функции}{prehardcoded-input-array1d-void}
\newpage
\codeexample{Отладочная фиксация: двумерный массив}{prehardcoded-input-array2d}
%\newpage
\codeexample{Вывод указателя на символ}{char_pointer_to_cout}
\newpage
\codeexample{Использование \textbf{cin} и \textbf{gets}  в одной программе}{cin-gets}
