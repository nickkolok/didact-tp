...
int main(){
	...
	// "Холостой" в том смысле, что прочитанная строка нигде не используется.
	cout << "Введите число:" << endl;
	cin >> n;
	char endlbuf[256];
	gets(endlbuf);
	...
	cin >> n1 >> n2;
	gets(endlbuf); // endlbuf нигде не используется, это "громоотвод"
	cout << "Введите строку: " << endl;
	gets(str);
	cout << "Введённая строка: " << endl;
	cout << str << endl;
	...
	// gets(endlbuf);
	cin >> n2;
	gets(endlbuf); // сбрасываем остатки потока (перевод строки), они нам не нужны
	cout << "Введите строку: " << endl;
	gets(str);
	cout << "Введённая строка: " << endl;
	cout << str << endl;
