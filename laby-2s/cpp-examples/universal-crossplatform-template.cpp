...
// Всё, что ниже этого комментария,
// рекомендуется просто копировать в каждую новую программу

// Если компиляция в MicroSoft Visual C++ - раскомментировать
//#include "stdafx.h"
// visual studio обязательно требует этот файл, а gcc его не признаёт
